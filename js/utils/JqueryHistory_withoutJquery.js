define(function() {
	...
	function initObjects(options) {
		options = options || {};
		options.unescape === undefined ? (options.unescape = false) : "";
		...
		function partialDecoder(chars) {
			var re = new RegExp($.map(chars, encodeURIComponent).join("|"),
				"ig");
			return function(enc) {
	...
	implementations.hashchangeEvent = {
		_init: function() {
			...
			window.addEventListener('hashchange', self.check);
		},
		check: function() {
			self.callback(locationWrapper.get());
		},
